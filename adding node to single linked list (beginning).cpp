...
void addFirst(string title, string writer, string publisher, int publication_year, int pages){
    newNode = new Book();
    newNode->title = title;
...
int main(){
    ...
    addFirst("ayah","nabila","guepedia",2019,209);
